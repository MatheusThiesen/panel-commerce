...
import { getOrderOne, orderStatusStyle } from "@/hooks/queries/useOrders";
import { cn } from "@/lib/utils";
import { CircleCheck, CircleX } from "lucide-react";
import { Metadata } from "next";
import { OrderOptionActions } from "../components/orderOptionActions";
...
export default async function HomePage({ params }: Props) {
  const order = await getOrderOne(+params.codigo);
    ...
    return (
      <Navigation
        breadcrumbs={[
          ...
          {
            href: `/app/pedidos/${order.codigo}`,
            title: order.codigo.toString(),
          },
        ]}
      >
        <DetailPage>
                  ...
                  secondaryColumn={
                    <>
                      ...
                      {order.vendedores.map((seller) => (
                        <DetailBox
                          key={
                            seller.vendedor.codigo.toLocaleString() +
                            seller.tipo
                          }
                          className="w-full"
                        >
